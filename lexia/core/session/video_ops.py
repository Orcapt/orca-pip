...
class VideoOperations:
    ...
    def send(self, url: str) -> None:
        """
        Stream video with Lexia markers.
        ...
        payload = f"[lexia.video.start]{url}[lexia.video.end]"
        self._stream(payload)
    
    def youtube(self, url: str) -> None:
        """
        Stream YouTube video with Lexia markers.
        ...
        payload = f"[lexia.youtube.start]{url}[lexia.youtube.end]"
        self._stream(payload)
