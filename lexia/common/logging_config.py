...
Centralized logging configuration for Lexia SDK.
...
def setup_logging(
    ...
    """
    Setup logging configuration for Lexia SDK.
    ...
    Example:
        ...
        >>> setup_logging(level=logging.DEBUG, log_file="lexia.log")
    """
    # Select format
    formats = {
    ...
    logger.info("Lexia logging configured successfully")
...
def get_logger(name: str) -> logging.Logger:
    ...
    """
    return logging.getLogger(f"lexia.{name}")


def set_level(level: int) -> None:
    """
    Set logging level for all Lexia loggers.
    
    Args:
        level: Logging level
        
    Example:
        >>> from lexia.logging_config import set_level
        >>> import logging
...
def disable_logging() -> None:
    """
    Disable all Lexia logging.
    
    Example:
        >>> from lexia.logging_config import disable_logging
        >>> disable_logging()
    """
    logging.getLogger("lexia").setLevel(logging.CRITICAL + 1)
...
def enable_debug_logging() -> None:
    ...
    Example:
        >>> from lexia.logging_config import enable_debug_logging
...
class LoggingContext:
    ...
    def __init__(self, level: int):
        ...
        """
        self.level = level
        self.original_level = logging.getLogger("lexia").level
